...
import org.demoiselle.geo.dao.WaysDAO;
...
public class WaysREST {

    private static final Logger LOG = getLogger(WaysREST.class.getName());
    ...
    @ApiOperation(value = "Lista de POI por categorias e nome",
            notes = "Lista de Ways. Cache de request 3600 segundos",
     ...
     * @return
     */
    @ApiOperation(value = "Resumo geral dos POIs Ways",
